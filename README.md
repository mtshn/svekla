**UPD: new version is available in 2025! Isomer generation by molecular formula, ranking based on molecular fingerprint predicted from mass spectrum, batch prediction.**
